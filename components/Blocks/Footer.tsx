...
export const Footer = () => {
  return (
    <footer className="border-t border-white/10 bg-[#07080C] text-[#8A8A94] text-xs">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-12 lg:py-16">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 lg:gap-12">
          {/* Brand Info (2 cols) */}
          <div className="col-span-2 space-y-4">
            <Link href="/" className="flex items-center gap-2.5">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-white/[0.06] border border-white/10 p-1 text-white">
                <img
              ...
              <span className="text-base font-bold tracking-tight text-white">Fabrica</span>
            </Link>

            <p className="text-xs text-[#8A8A94] max-w-sm leading-relaxed">
              Business-First, Coding-First Agentic Development Environment for solo founders, independent consultants, and lean teams.
            </p>

            {/* Operational Status */}
            <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full bg-white/[0.03] border border-white/10 text-[11px] font-mono text-emerald-400">
          ...
          <div className="space-y-3">
            <h4 className="text-xs font-mono font-semibold uppercase tracking-wider text-white">Product</h4>
          ...
          {/* Nav Column 2 */}
          <div className="space-y-3">
            <h4 className="text-xs font-mono font-semibold uppercase tracking-wider text-white">Capabilities</h4>
            <ul className="space-y-2">
          ...
          {/* Nav Column 3 */}
          <div className="space-y-3">
            <h4 className="text-xs font-mono font-semibold uppercase tracking-wider text-white">Company</h4>
            <ul className="space-y-2">
        ...
        {/* Bottom Bar */}
        <div className="mt-12 pt-6 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] font-mono text-[#8A8A94]">
          <p>© {new Date().getFullYear()} Fabrica Systems Inc. All rights reserved. &ldquo;The Next AI Exit.&rdquo;</p>
