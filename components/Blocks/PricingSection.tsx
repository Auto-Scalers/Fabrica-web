        ...
        <Reveal className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <div className="pt-4 flex items-center justify-center">
            <ToggleGroup
              ...
              spacing={2}
              className="flex items-center bg-[var(--overlay-5)] p-1 rounded-xl border border-[var(--border-subtle)]"
            >
              <ToggleGroupItem
                value="monthly"
          ...
          {pricingTiers.map((tier) => (
            <div
              ...
              className={cn(
                ...
                tier.highlight
                  ? 'bg-[var(--surface-card)] border-2 border-orange-500 shadow-2xl shadow-orange-950/40 lg:-translate-y-2'
            ...
            >
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-xl font-bold text-[var(--text-strong)]">{tier.name}</h3>
              ...
              <div className="pt-8">
                {tier.highlight ? (
                  <ShimmerButton
                    ...
                    className="w-full text-xs font-semibold shadow-lg shadow-orange-950/40"
                  ...
                  <a
                    href="#waitlist"
                    className="w-full py-3 rounded-xl font-semibold text-xs transition-all flex items-center justify-center gap-2 bg-[var(--overlay-5)] hover:bg-[var(--overlay-10)] border border-[var(--border-subtle)] text-[var(--text-strong)]"
                  >
                    <span>{tier.ctaText}</span>
                    <ArrowRight className="h-3.5 w-3.5" />
                  </a>
